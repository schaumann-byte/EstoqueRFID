...
export default function CadastroPage() {
    ...
    try {
      ...
      if (!signupResp.ok) {
        ...
        try {
          ...
          if (signupResp.status === 409) msg = "E-mail ou nome de guerra já cadastrado.";
          if (signupResp.status === 422) msg = "Dados inválidos. Verifique os campos.";
        } catch {}
        throw new Error(msg);
      }
  ...
  return (
    <main className="min-h-dvh w-full bg-gradient-to-br from-slate-600 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="mx-auto flex w-full max-w-5xl max-h-[90vh] overflow-hidden rounded-xl bg-white shadow-2xl">
        {/* Left - Image */}
        ...
        {/* Right - Form com scroll */}
        <div className="w-full md:w-[60%] flex flex-col">
          <div className="p-6 sm:p-8 pb-4">
            <h1 className="text-center text-3xl font-semibold text-slate-900">Cadastro</h1>
          </div>
